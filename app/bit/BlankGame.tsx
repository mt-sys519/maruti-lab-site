  ...
  if (phase === "complete") {
    return (
      <section className="bitGameShell bitResult" aria-labelledby="blank-result-title">
        ...
        <XShareButton text={`MarutiBit「BLANK」\n${levelNames[difficulty]} / SCORE ${score.toLocaleString()} / ${correct} CORRECT / TIME ${(totalTime / 1000).toFixed(1)}s`} url="https://marutilab.com/bit/blank" />
