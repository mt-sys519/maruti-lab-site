...
function angleIcon(scale) {
  return `<g transform="scale(${scale}) translate(-52 -40)">
    ...
    <text x="43" y="60" text-anchor="middle" fill="${palette.accent}" font-family="'Yu Gothic UI', sans-serif" font-weight="700" font-size="${(15 / scale).toFixed(2)}">?</text>
  </g>`;
}
function blankIcon(scale) {
  return `<g transform="scale(${scale})" font-family="Georgia, serif">
    ...
    <text x="-28" y="5" text-anchor="middle" fill="${palette.line}" font-size="12">＋</text>
    ...
    <text x="20" y="5" text-anchor="middle" fill="${palette.line}" font-size="12">＝</text>
