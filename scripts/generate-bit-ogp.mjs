...
function blankIcon(scale) {
  return `<g transform="scale(${scale})" font-family="Georgia, serif">
    ...
    <text x="42" y="2.9" text-anchor="middle" fill="${palette.ink}" font-size="18">13</text>
  </g>`;
}
function sequenceIcon(scale) {
  return `<g transform="scale(${scale})" font-family="Georgia, serif" font-size="18">
    <g transform="translate(-48 6.1) scale(1 1.35) translate(48 -6.1)">
      <text x="-48" y="6.1" text-anchor="middle" fill="${palette.ink}">2</text>
    </g>
    <text x="-22" y="3" text-anchor="middle" fill="${palette.ink}">4</text>
...
// NEON BREAK's cards are generated by scripts/generate-neonbreak-ogp.mjs, in
// the newer AVENUE layout that uses the game's own art. This icon is kept
// because the hub card uses the same shape.
