...
function overlay(width, height, square = false) {
  ...
  return Buffer.from(`
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="${left}" y="${titleY}" fill="#f0f3ed" font-family="Georgia, serif" font-size="${titleSize}" font-weight="500" letter-spacing="5">RAIN CHIME</text>
...
console.log("Generated RAIN CHIME OGP images.");
